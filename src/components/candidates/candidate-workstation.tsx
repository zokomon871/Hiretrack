        ...
        {viewMode === 'split' ? (
          ...
          <div className="h-full flex flex-col bg-card rounded-2xl border border-border overflow-hidden relative shadow-xs">
            ...
            {selectedForBulk.length > 0 && (
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 glass-card bg-popover/90 backdrop-blur-xl text-popover-foreground px-4 py-2.5 rounded-2xl shadow-2xl glow-box border border-border/80 flex items-center gap-3 z-30 animate-in fade-in slide-in-from-bottom-3 duration-200">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <select
                    ...
                    defaultValue=""
                    className="h-7 px-2 text-xs rounded-lg bg-card border border-border text-foreground font-medium focus:outline-none focus:ring-1 focus:ring-primary"
                  >
